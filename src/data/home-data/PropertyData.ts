...
const property_data: DataType[] = [
   {
      ...
      address: "Beverly Hills, Los Angeles, CA 90210",
      property_info: [
   ...
   },
   {
      ...
      title: "Luxury Villa in Lake Tahoe",
      address: "Lake Tahoe, California, USA",
      property_info: [
         { icon: propertyIcon_1, feature: "sqft", total_feature: 1270 },
...

   {
      ...
      address: "Beverly Hills, Los Angeles, CA 90210",
      property_info: [
         { icon: propertyIcon_1, feature: "sqft", total_feature: 1780 },
         { icon: propertyIcon_2, feature: "bed", total_feature: 3 },
         { icon: propertyIcon_3, feature: "bath", total_feature: 2 },
      ],
      price: 34900,
   ...
   },
   {
      ...
      address: "Lake Tahoe, California, USA",
      property_info: [
         { icon: propertyIcon_1, feature: "sqft", total_feature: 1857 },
         { icon: propertyIcon_2, feature: "bed", total_feature: 3 },
   ...
   ,
   {
      ...
      property_info: [
         { icon: propertyIcon_1, feature: "sqft", total_feature: 2450 },
